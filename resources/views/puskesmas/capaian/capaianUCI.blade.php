{{--http://localhost:8080/project_sipi/uci-puskesmas.php
--}}
    ...
    <script type="text/javascript">
        $(function () {
            $('#quarter{{$quarter}}').DataTable({
                ...
                ajax: "{{ route('data-ajax.uci.puskesmas', ['year'=> $tahunForm, 'kabupaten'=>$kabupatenForm, 'puskesmas'=>$puskesmasForm, 'quarter'=>$quarter]) }}",
                columns: [
