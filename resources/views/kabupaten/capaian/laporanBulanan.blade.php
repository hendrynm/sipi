                        ...
                        <table class="table table-borderless laporan-bulanan" id="table{{$i}}">
                            <thead class="thead-light">
                                ...
                                <tr>
                                    ...
                                    {{-- Baduta --}}
                                    <th scope="col" colspan="3" class="align-middle">Baduta</th>
                                    ...
                                    {{-- SD 5 --}}
                                    <th scope="col" colspan="3" class="align-middle">SD Kelas 5</th>
                                    ...
                                    <th scope="col" colspan="6" class="tabel-antigen">Td (Kelas 5)</th>
                                     ...
                                     {{-- SD 6 --}}
                                     <th scope="col" colspan="3" class="align-middle">SD Kelas 6</th>
