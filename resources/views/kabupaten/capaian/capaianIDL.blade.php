{{--http://localhost:8080/project_sipi/idl-puskesmas.php
--}}

@extends("_partials.master")
@section("title","Ketercapaian Imunisasi Dasar Lengkap (IDL) Setiap Puskesmas")
...
@section("konten")
    <div class="container">
        ...
        <hr>
        <h1>Ketercapaian Imunisasi Dasar Lengkap (IDL) Setiap Puskesmas</h1>
        <div class="jumbotron">
            <form method="get">
